...
class PaymentSuccessCancelTestCase(APITestCase):
    def setUp(self):
        ...
        self.book = Book.objects.create(title="Book", author="Author", cover="HARD", inventory=3, daily_fee=1)
    ...
    def test_payment_success(self, mock_retrieve):
        ...
        url = reverse("Payment:payment-success") + f"?session_id={self.payment.session_id}"
